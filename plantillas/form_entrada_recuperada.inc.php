...
<div class="form-group">
	...
	<textarea class="form-control" rows="5" id="texto" name="texto" placeholder="Escribe aquí tu artículo."><?php echo $entrada_recuperada -> obtener_texto(); ?></textarea>
	<input type="hidden" id="texto-original" name="texto-original" value="<?php echo $entrada_recuperada -> obtener_texto(); ?>">
</div>
<div class="checkbox">
	<label>
		<input type="checkbox" name="publicar" value="si" <?php if ($entrada_recuperada -> esta_activa()) echo 'checked' ?>>Marca este recuadro si quieres que la entrada se publique de inmediato
